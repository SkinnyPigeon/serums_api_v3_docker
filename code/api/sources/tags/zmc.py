...
zmc_patient_details_3 = {'tag': 'patient_details', 'table': 'zmc.wearable', 'fields': ['patnr', 'datum', 'duur_meting', 'tijd_gezeten', 'tijd_gelopen', 'aantal_keren_opgestaan_uit_een_stoel', 'aantal_stappen_gezet', 'gemiddeld_aantal_stappen_per_minuut'], 'key_lookup': {}}
...
zmc_personal_1 = {'tag': 'personal', 'table': 'zmc.patient_details', 'fields': ['patnr','gschl','nname','nnams','gbdat','natio'], 'key_lookup': {}}
zmc_personal_2 = {'tag': 'personal', 'table': 'zmc.wearable', 'fields': ['patnr', 'datum', 'duur_meting', 'tijd_gezeten', 'tijd_gelopen', 'aantal_keren_opgestaan_uit_een_stoel', 'aantal_stappen_gezet', 'gemiddeld_aantal_stappen_per_minuut'], 'key_lookup': {}}
...
zmc_all_14 = {'tag': 'all', 'table': 'zmc.wearable', 'fields': ['patnr', 'datum', 'duur_meting', 'tijd_gezeten', 'tijd_gelopen', 'aantal_keren_opgestaan_uit_een_stoel', 'aantal_stappen_gezet', 'gemiddeld_aantal_stappen_per_minuut'], 'key_lookup': {}}

zmc_tags = [zmc_wearable, zmc_diagnostic_1, zmc_diagnostic_2, zmc_medication, zmc_patient_details_1, zmc_patient_details_2, zmc_patient_details_3, zmc_patient_address, zmc_patient_appointment, zmc_operations, zmc_documents, zmc_healthcare_providers, zmc_drugs_and_alcohol_1, zmc_drugs_and_alcohol_2, zmc_drugs_and_alcohol_3, zmc_allergies, zmc_additional_information_1, zmc_additional_information_2, zmc_additional_information_3, zmc_treatments_1, zmc_treatments_2, zmc_personal_1, zmc_personal_2, zmc_all_1, zmc_all_2, zmc_all_3, zmc_all_4, zmc_all_5, zmc_all_6, zmc_all_7, zmc_all_8, zmc_all_9, zmc_all_10, zmc_all_11, zmc_all_12, zmc_all_13, zmc_all_14]