...
fcrb_patient_appointments_2 = {'tag': 'appointments', 'table': 'fcrb.order_entry', 'fields': ['einri', 'falnr', 'patnr', 'orgid', 'pernr', 'idodr', 'erdat'], 'key_lookup': {}}
...
fcrb_tags = [fcrb_wearable_1, fcrb_wearable_2, fcrb_diagnostic_1, fcrb_diagnostic_2, fcrb_medication, fcrb_patient_details_1, fcrb_patient_details_2, fcrb_patient_address, fcrb_patient_appointments_1, fcrb_patient_appointments_2, fcrb_treatments_1, fcrb_treatments_2, fcrb_healthcare_providers_1, fcrb_healthcare_providers_2, fcrb_personal, fcrb_all_1, fcrb_all_2, fcrb_all_3, fcrb_all_4, fcrb_all_5, fcrb_all_6, fcrb_all_7, fcrb_all_8, fcrb_all_9, fcrb_all_10]