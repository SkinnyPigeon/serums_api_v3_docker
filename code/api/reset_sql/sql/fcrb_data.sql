...
insert into fcrb.translated_tags (tags) values ('{"wearable": {"translation": "Portable"}, "diagnostic": {"translation": "Diagnòstic"}, "medication": {"translation": "Medicació"}, "patient_details": {"translation": "Detalls de Pacient"}, "patient_address": {"translation": "Adreça de pacient"}, "appointments": {"translation": "Cites"}, "healthcare_providers": {"translation": "Proveïdors de Salut"}, "treatments": {"translation": "Tractaments"}, "personal": {"translation": "Personal"}, "all": {"translation": "Tots"}}');
